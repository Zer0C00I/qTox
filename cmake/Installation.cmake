...
if(APPLE)
  ...
  list(APPEND PROJECT_ICONS "assets/resources/images/icons/${BINARY_NAME}.icns")
  list(APPEND PROJECT_ICONS "assets/resources/images/icons/${BINARY_NAME}_profile.icns")
...
elseif(WIN32)
  ...
  foreach(size ${ICON_SIZES})
    set(path_from "assets/img/icons/${size}x${size}/${BINARY_NAME}.png")
  ...
  set(SVG_SRC "${CMAKE_SOURCE_DIR}/assets/img/icons/${BINARY_NAME}.svg")
